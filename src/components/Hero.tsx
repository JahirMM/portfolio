    ...
    <>
      ...
      <div className="relative z-[998] inline-flex justify-start p-0 m-0 mb-5 cursor-pointer">
        <a
          ...
          className="flex items-center gap-2 px-3 py-2 text-sm font-semibold text-gray-700 border border-black rounded-xl dark:bg-primaryColorDarkTheme dark:border-white dark:text-white"
        >
      ...
      <div className="mb-10">
        <h1 className="font-black leading-none tracking-tight text-center md:text-start">
          <span className="text-5xl text-gray-900 sm:text-8xl md:text-9xl text-response dark:text-white">
            HOLA, SOY
          </span>
        </h1>
        <h2
          className="mt-3 text-5xl font-black leading-none tracking-tight text-center text-transparent sm:mt-0 sm:text-8xl md:text-9xl md:text-start text-response headline"
          style={{ WebkitTextStroke: theme ? "2px #CBCACA" : "2px #808080" }}
        >
          JAHIR MACHUCA
        </h2>
      </div>
      ...
      <div className="grid items-center gap-16 md:grid-cols-2">
        ...
        <div className="space-y-8">
          ...
          <nav className="flex flex-wrap gap-4">
            ...
            <div className="flex items-center justify-center px-4 py-2 transition bg-gray-200 border border-black rounded-full gap-x-4 dark:border-white/10 contact dark:bg-white/10">
              <a
                href="mailto:j.machuca912@gmail.com"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Enviar un correo a Jahir Machuca"
              >
                <Mail className="text-black size-5 dark:text-gray-200" />
              </a>
              <a
                href="mailto:j.machuca912@gmail.com"
                className="text-sm text-black hover:underline sm:text-base dark:text-gray-200"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Enviar un correo a Jahir Machuca"
              >
              ...
              <span className="relative">
                <Copy
                  className="text-black cursor-pointer size-5 hover:text-gray-600 dark:hover:text-gray-300 dark:text-gray-200"
                  onClick={handleCopy}
